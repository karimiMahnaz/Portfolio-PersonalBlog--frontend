      ...
      <Container fluid >
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav
            ...
            navbarScroll
          >
             <Nav.Link href="/profile" active = {router.pathname.split("/")[1] === "profile"}  >Home</Nav.Link>
             ...
             <Nav.Link href="/contactMe" active = {router.pathname.split("/")[1] === "contactMe"} >Contact Me</Nav.Link>
          </Nav>
